import { Restaurante } from './../../common/restaurante.interface';
...
export class HomeComponent implements OnInit {
    ...
    nomeRestaurante: Array<Restaurante>;
    ...
    async adicionarRestaurantes() {
        if (
            this.formRestaurante.get('nomeRestaurante')?.value ==
            (undefined || '')
        ) {
    ...
    async buscaRestauranteID(id: number) {
        ...
        await this.restauranteSerice
            ...
            .then((data: any) => {
                this.nomeRestaurante = data.nome;

                this.formRestaurante
                    .get('novoNomeRestaurante')
                    ?.setValue(this.nomeRestaurante);
            })
            .catch();
    }
